# 🎙️ Premium Text-to-Speech Application

An institutional-grade web interface for high-fidelity speech synthesis, powered by the **Murf AI SDK** and **FastAPI**. This application features a stunning glassmorphic UI, real-time audio visualization, and deep customization options.
